...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      ...
      .then(
        (result) => {
          toast.success("Message sent to Vipul Nayak");
        },
        (error) => {
      ...
      <div className="container contact__container">
        <div className="contact__options">
          ...
          >
            ...
            <h4>Email</h4>
            <h5>vipulnayak1192@gmail.com</h5>
            <a
              href="mailto:vipulnayak1192@gmail.com"
              target="_blank"
              rel="noreferrer"
            >
              Email me
          ...
          >
            ...
            <h5>Vipul Nayak</h5>
            <a
              href="https://www.linkedin.com/in/vipul-nayak-22a6a8253/"
              target="_blank"
              rel="noreferrer"
            >
              Let's connect
          ...
          >
            ...
            <h5>Vipul Nayak</h5>
            <a
              href="https://www.instagram.com/_.vipull._/"
              target="_blank"
              rel="noreferrer"
            >
              Send a DM
